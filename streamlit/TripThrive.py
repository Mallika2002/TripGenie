...
def update_sidebar_user(user_input):
    if user_input:
        ...
        user_data_path = os.path.join(os.path.dirname(_file_), '..', 'user_data.txt')
...
def trip_planner_section():
    ...
    user_data_path = os.path.join(os.path.dirname(_file_), '..', 'user_data.txt')
    user_path = os.path.join(os.path.dirname(_file_),'user.txt')
    no_user_data_path = os.path.join(os.path.dirname(_file_), '..', 'no_user_data.txt')
