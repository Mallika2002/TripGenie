...
- Suggest the best mode of transportation to the destination from {user_location}. Highlight any 
  ...
  along the way.
- Recommend the best stay locations in advance. Provide options that suit their preferences.Provide them the contacts and valid MapQuest maps from {user_location} to the location suggestions made and all possible travel options from {user_location} to {user_input}.
...
Return the response as markdownzz and make sure to include the titles with each point.
